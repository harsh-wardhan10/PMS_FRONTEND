					...
					<div>
						...
						<Form.Item
							...
							<DatePicker
								name='designationStartDate'
								format='YYYY-MM-DD'
								onChange={(date) => setdesignationStartDate(moment(date).format("ddd, DD MMM YYYY HH:mm:ss [GMT]"))}
							/>
						</Form.Item>
						...
						<Form.Item
							...
							<DatePicker
								...
								onChange={(date) => setdesignationEndDate(moment(date).format("ddd, DD MMM YYYY HH:mm:ss [GMT]"))}
							/>
						</Form.Item>
