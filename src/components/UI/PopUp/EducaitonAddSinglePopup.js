				...
				<Form
					...
					<div>
						...
						<Form.Item
							...
							<DatePicker onChange={(date) => setstudyStartDate(moment(date).format("ddd, DD MMM YYYY HH:mm:ss [GMT]"))} />
						</Form.Item>
						...
						<Form.Item
							...
							<DatePicker onChange={(date) => setstudyEndDate(moment(date).format("ddd, DD MMM YYYY HH:mm:ss [GMT]"))} />
						</Form.Item>
