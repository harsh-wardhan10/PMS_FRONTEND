				...
				<Form
					...
					<div>
						...
						<Form.Item
							...
							<DatePicker
								name='studyStartDate'
								onChange={(date) => setstudyStartDate(moment(date).format("ddd, DD MMM YYYY HH:mm:ss [GMT]"))}
								format='YYYY-MM-DD'
							/>
						</Form.Item>
						...
						<Form.Item
							...
							<DatePicker
								name='studyEndDate'
								onChange={(date) => setstudyEndDate(moment(date).format("ddd, DD MMM YYYY HH:mm:ss [GMT]"))}
								format='YYYY-MM-DD'
							/>
						</Form.Item>
