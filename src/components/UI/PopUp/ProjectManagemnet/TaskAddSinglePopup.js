				...
				<Form
					...
					<div>
						...
						<Form.Item
							...
							<DatePicker onChange={(date) => setstartDate(moment(date).format("ddd, DD MMM YYYY HH:mm:ss [GMT]"))} />
						</Form.Item>
						...
						<Form.Item
							...
							<DatePicker onChange={(date) => setendDate(moment(date).format("ddd, DD MMM YYYY HH:mm:ss [GMT]"))} />
						</Form.Item>
