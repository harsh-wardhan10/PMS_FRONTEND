				...
				<Form
					...
					<div>
						...
						<Form.Item
							...
							<DatePicker onChange={(date) => setsalaryStartDate(moment(date).format("ddd, DD MMM YYYY HH:mm:ss [GMT]"))} />
						</Form.Item>
						...
						<Form.Item
							...
							<DatePicker onChange={(date) => setsalaryEndDate(moment(date).format("ddd, DD MMM YYYY HH:mm:ss [GMT]"))} />
						</Form.Item>
